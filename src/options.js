...
function createMirrorElement(domainList, mirrorName, mirrorSString, dataID) {
  ...
  icon.addEventListener("error", function () {
    this.class = "v-centered icon MyVideo";
  });
  ...
  (function (domainList, dataID, mirrorName, mirrorSString) {
    mirrorEl.addEventListener("click", function () {
      openAddEditMirrorDialog(domainList, dataID, mirrorName, mirrorSString);
    });
  })(domainList, dataID, mirrorName, mirrorSString);
  mirrorEl.addEventListener("dragstart", function (e) {
    dragStart(e);
  });
  mirrorEl.addEventListener("dragenter", function (e) {
    dragEnter(e);
  });
  return mirrorEl;
}
...
function createAddElement(domainList, dataID) {
  ...
  if (dataID === null) { //add domain element
    ...
    addEl.addEventListener("click", function () {
      openAddEditDomainDialog(domainList, "addDomain");
    });
  } else { //add mirror element
    addEl.dataset.id = dataID;
    addEl.setAttribute("id", "addMirror");
    addEl.addEventListener("click", function () {
      openAddEditMirrorDialog(domainList, dataID, "addMirror");
    });
  }
  return addEl;
}
...
function createDomainElement(domainList, domain) {
  ...
  domainEl.addEventListener("click", function () {
    openAddEditDomainDialog(domainList, domain);
  });
  return domainEl;
}
